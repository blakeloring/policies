# CoSo Cloud HIPAA Compliance Policies

HIPAA compliance is complicated, but it doesn't have to be. CoSo Cloud helps relieve the technical burden with our HIPAA-compliant cloud computing platform and solutions for healthcare.
...
2. When ready, download the policies and comb through for mentions of CoSo Cloud or our business and change to appropriate references to your company.
3. Publish your policies in a publicly available location. The files are markdown, so you may need to convert to HTML if you don't have a publishing platform capable of markdown format. You can either create an index page linking to each individual policy, or create a single page listing all the policies in line, [much like we did](https://policy.CoSo Cloud.com).

## Who is behind this?

[CoSo Cloud](htts://CoSo Cloud.com), healthcare's trusted HITRUST CSF Certified digital health platform.

We help companies who handle PHI, both business associates and covered entities, maintain compliance with our ([Compliant Cloud](https://CoSo Cloud.com/compliant-cloud)) and ([Managed Integration](https://CoSo Cloud.com)).

To get in touch, shoot us an email at [hello@CoSo Cloud.com](mailto:hello@CoSo Cloud.com). We'd love to hear from you!
...
* [CoSo Cloud HIPAA Business Associate Agreement (“BAA”)](source/sections/23-CoSo Cloud_hipaa_business_associate_agreement.md)
* [HIPAA Mappings to CoSo Cloud Controls](source/sections/24-hipaa_mapping_to_CoSo Cloud_controls.md)
